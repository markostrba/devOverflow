...
/**
 * Sign-up form component that validates input and creates a new user account.
 *
 * Renders fields for full name, username, email, and password (with a visibility toggle and password strength indicator),
 * validates input against the sign-up schema, displays success or error toasts for submission outcomes, and navigates to the home route when account creation succeeds.
 *
